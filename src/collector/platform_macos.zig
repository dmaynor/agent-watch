// macOS platform support — stub for cross-platform compilation
// Will use libproc API (proc_listallpids, proc_pidinfo) via Zig C interop

const std = @import("std");
const types = @import("../data/types.zig");
const Allocator = std.mem.Allocator;

// Stubs — macOS implementation requires libproc which is only available on macOS
